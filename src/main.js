...
document.querySelector('#app').innerHTML = `
  ...
  <main>
    <section class="intro"><div><p class="eyebrow">INPUT DIAGNOSTICS / 00</p><h1>Every click,<br><em>accounted for.</em></h1></div><div class="intro-copy"><p>Test your mouse buttons, wheel, and movement in real time. A quiet little check for the hardware you use every day.</p></div></section>
    <section class="workbench" aria-label="Mouse test area">
      <div class="tester-panel"><div class="panel-top"><span>LIVE TEST AREA</span><span class="panel-prompt">Move your mouse here <span aria-hidden="true">↘</span></span><span class="panel-coordinate" id="coordinates">000 / 000</span></div>
